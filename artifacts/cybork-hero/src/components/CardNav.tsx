  ...
  return (
    <div className={`card-nav-container ${className}`}>
      <nav ref={navRef} className={`card-nav ${isExpanded ? 'open' : ''}`}>
        {/* Bottom corner brackets (top ones handled by CSS ::before/::after) */}
        <span className="card-nav-bracket-bl" />
        <span className="card-nav-bracket-br" />
        ...
        <div className="card-nav-top">
          ...
          <div className="logo-container">
            ...
            <span className="logo-wordmark">CYBORK</span>
          </div>
